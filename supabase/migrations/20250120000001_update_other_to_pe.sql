-- Migration: Update records from 'Other' to 'PE'
-- Version: 2025_01_20_other_to_pe_part2
-- Description: Updates existing contact records and triggers
-- NOTE: This must run AFTER 20250120000000_rename_other_to_pe.sql is committed
...
-- Record this migration (part 2)
INSERT INTO migration_versions (version) 
VALUES ('2025_01_20_other_to_pe_part2')
